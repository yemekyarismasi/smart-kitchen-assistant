      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 h-14 flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-1">
          {navLinks.map(link => (
            <a
              key={link.href}
              href={link.href}
              className="px-3 py-1.5 text-sm text-zinc-400 hover:text-white rounded-lg hover:bg-zinc-800/60 transition-all"
            >
              {link.label}
            </a>
          ))}
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <a
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-zinc-700 bg-zinc-900/60 hover:border-zinc-500 transition-all text-xs text-zinc-300 hover:text-white"
          >
          ...
          <a
            href="#licensing"
            className="px-3 md:px-4 py-1.5 rounded-lg bg-cyan-500 text-black font-bold text-xs md:text-sm hover:bg-cyan-400 transition-all shadow-[0_0_15px_rgba(34,211,238,0.3)]"
          >
            B2B License
          </a>
          ...
          <button
            ...
            className="md:hidden p-1.5 rounded-lg border border-zinc-700 text-zinc-400 hover:text-white hover:border-zinc-500 transition-all"
