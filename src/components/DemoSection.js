...
export default function DemoSection() {
  ...
  return (
    <div className="w-full relative pt-2 md:pt-4 pb-6 md:pb-16 scroll-mt-20" id="interactive-demo">
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-start relative z-10 px-6">
        ...
        <div className="space-y-6 text-center lg:text-left">
          ...
          <div id="demo" className="mb-10 lg:mb-12 scroll-mt-20">
          ...
          {recipe ? (
            <div className="flex flex-col h-full relative z-10">
              ...
              <div className="absolute top-6 right-6 flex items-center gap-2 bg-zinc-900/90 px-4 py-2 rounded-full border border-cyan-500/50 backdrop-blur-md z-30 shadow-[0_0_15px_rgba(34,211,238,0.3)]">
                <span className="text-sm md:text-xs font-mono text-cyan-400 font-bold uppercase tracking-widest">Step 2: Edge Voice AI</span>
              </div>
              ...
              <div className="h-56 bg-black relative border-b border-zinc-800 shrink-0">
                ...
                <div className="absolute bottom-4 left-6 flex flex-wrap gap-2 pr-6">
                  <span className="bg-cyan-500 text-black px-3 py-1 rounded-full text-sm md:text-xs font-bold uppercase tracking-wider shadow-lg">{recipe.difficulty}</span>
                  <span className="bg-zinc-800 border border-zinc-600 text-white px-3 py-1 rounded-full text-sm md:text-xs font-bold uppercase tracking-wider shadow-lg flex items-center gap-1">⏱️ Prep: {recipe.prepTime}</span>
                  <span className="bg-zinc-800 border border-zinc-600 text-white px-3 py-1 rounded-full text-sm md:text-xs font-bold uppercase tracking-wider shadow-lg flex items-center gap-1">🔥 Cook: {recipe.cookTime}</span>
                  <span className="bg-zinc-800 border border-zinc-600 text-white px-3 py-1 rounded-full text-sm md:text-xs font-bold uppercase tracking-wider shadow-lg flex items-center gap-1">🍽️ {recipe.portions}</span>
                </div>
              </div>
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <p className="text-zinc-300 mb-6 font-light text-base md:text-[15px] md:text-sm leading-relaxed">{recipe.description}</p>
                
                {/* AI Creation Footnote */}
                <div className="bg-cyan-950/20 border border-cyan-900/40 rounded-xl p-4 mb-8">
                  <p className="text-sm md:text-xs text-zinc-300 leading-relaxed font-mono">
      ...
      <div className="mt-8 w-full max-w-7xl mx-auto p-6 md:p-8 rounded-2xl bg-cyan-950/20 border border-cyan-900/50 text-left shadow-lg">
        ...
        <p className="text-sm md:text-xs md:text-sm text-zinc-300 font-mono mb-4 leading-relaxed">
        ...
        <ul className="text-sm md:text-xs md:text-sm text-zinc-300 font-mono space-y-3 pl-4 border-l-2 border-cyan-900/50">
          <li>
