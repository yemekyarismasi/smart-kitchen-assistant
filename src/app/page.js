    ...
    <>
      ...
      <section id="features" className="w-full max-w-7xl mx-auto mb-12 px-4 scroll-mt-20">
        <div className="text-center mb-12">
          ...
          <p className="text-zinc-300 text-lg max-w-3xl mx-auto font-light leading-relaxed">
            Every architectural innovation below is <strong className="text-white">live in our open-source codebase</strong>. Inspect it, fork it, and test our hands-free culinary vision locally. This is our transparent engineering guarantee.
          </p>
        </div>
      ...
      <section id="faq" className="w-full max-w-7xl mx-auto mb-20 px-4 scroll-mt-20">
        ...
        <div className="space-y-4 w-full">
          ...
          <details className="group bg-zinc-900/60 border border-zinc-800 rounded-2xl overflow-hidden hover:border-cyan-800/60 transition-colors">
            ...
            <div className="px-6 pb-6 text-zinc-300 text-[15px] md:text-sm leading-relaxed border-t border-zinc-800 pt-4">
              <p>Traditional cloud-based smart assistants send your voice recordings to internet servers, creating massive GDPR and data privacy vulnerabilities. Yemek AI (FreeCuli) smart kitchen technology operates on the principle of "Privacy by Design." Because our Edge AI runs directly on the appliance's local chip, your voice data and kitchen habits are never uploaded to the internet. This guarantees 100% GDPR/CCPA compliance and absolute data privacy.</p>
            </div>
          </details>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://github.com/FreeCuli/smart-kitchen-offline-assistant" target="_blank" rel="noopener noreferrer" className="text-zinc-300 hover:text-white text-sm transition-colors flex items-center gap-2">
                  ...
                  Smart Kitchen Offline Assistant
                </a>
              </li>

              <li>
                <a href="https://github.com/FreeCuli/smart-kitchen-standards" target="_blank" rel="noopener noreferrer" className="text-zinc-300 hover:text-white text-sm transition-colors flex items-center gap-2">
                  <svg className="w-4 h-4 fill-current shrink-0" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                  Smart Kitchen Standards
                </a>
              </li>
              <li>
                <a href="https://medium.com/@oytunciba/freeculi-the-new-global-standard-for-smart-kitchen-ai-17f0cfbea03d" target="_blank" rel="noopener noreferrer" className="text-zinc-100 hover:text-white text-sm transition-colors flex items-center gap-2 font-semibold">
