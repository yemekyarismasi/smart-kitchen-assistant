...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center p-6 md:p-24 overflow-x-hidden bg-black text-white">
      
      {/* 1. HERO SECTION */}
      <section className="w-full max-w-5xl text-center space-y-10 mt-16 mb-40 relative z-10">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-tight">
          Smart Kitchen Assistant <br />
          <span className="neon-text-gradient">Next-Gen Edge AI</span>
        </h1>
      ...
      <section className="w-full max-w-7xl mb-40 relative">
        <div className="mb-20 text-center md:text-left">
          ...
          <p className="text-2xl text-zinc-400 max-w-3xl font-light">
      ...
      <section className="w-full max-w-7xl mb-40">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="flex-1 space-y-8">
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tight">Reverse-Engineering Reality</h2>
...
> PIPELINE COMPLETED. 0 ERRORS.`}
      ...
      <section id="licensing" className="w-full max-w-5xl mx-auto text-center space-y-10 mb-32 p-12 glass-panel rounded-3xl border border-zinc-800 relative overflow-hidden">
        ...
        <h2 className="text-4xl md:text-6xl font-black relative z-10">Dual-Licensing Strategy</h2>
        <p className="text-xl text-zinc-400 max-w-3xl mx-auto leading-relaxed relative z-10">
        ...
        <div className="bg-black/50 p-10 rounded-2xl border border-zinc-800 inline-block text-left mt-10 max-w-3xl relative z-10 w-full shadow-2xl">
          <h3 className="text-2xl font-bold text-white mb-4">Enterprise / Commercial SDK</h3>
          ...
          <button className="w-full py-5 rounded-xl bg-white text-black font-extrabold text-xl hover:bg-gray-200 transition-colors">
