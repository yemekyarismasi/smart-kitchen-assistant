...
| Type | Terms |
|---|---|
| **Open Source (AGPL-3.0)** | Free to use. Any embedding in proprietary software requires open-sourcing the full stack. |
| **Commercial License** | Available for hardware OEMs embedding this in closed-source IoT firmware. |
